...
useHead({
  title: () => 'Challenge #3: Todo List - Beginner Vue Challenges',
})
...
const challenge = {
  ...
  title: 'Todo List',
  difficulty: 'beginner',
  description: 'Create a todo list where users can add, remove, and toggle completion status.',
  objectives: [
    'Create an array to store todo items',
    'Implement input field for new todos',
    'Add functionality to append new todos',
    'Display all todos in a list using v-for',
    'Toggle completion status on click',
    'Remove todos from the list',
  ],
  hints: [
    'Use ref([]) to create an empty array for todos',
    'Each todo should be an object with text and completed properties',
    'Use v-model to bind input to a variable',
    'Use v-for to render the list of todos',
    'Use splice() or filter() to remove items',
  ],
  topics: ['v-for', 'v-model', 'List Rendering'],
}
...
&lt;/script&gt;</code></pre>
          ...
          <div class="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            ...
            <ul class="text-sm text-blue-700 dark:text-blue-400 space-y-1">
              <li>• <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">v-model</code> binds input to state</li>
              <li>• <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">v-for</code> renders each todo item</li>
              <li>• Each todo is an object with <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">text</code> and <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">completed</code></li>
              <li>• <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">splice()</code> removes items by index</li>
            </ul>
          </div>
        </div>
      </div>
