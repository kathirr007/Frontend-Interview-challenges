...
useHead({
  title: () => 'Challenge #1: Hello World Component - Beginner Vue Challenges',
})
...
const challenge = {
  ...
  difficulty: 'beginner',
  description: 'Create a simple Vue component that displays "Hello, Vue!" with reactive data.',
  objectives: [
    'Create a Vue component using Composition API (setup script)',
    'Use reactive data with ref() or reactive()',
    'Display text in the template',
    'Understand basic component structure',
  ],
  hints: [
    'Use <script setup> for Composition API',
    'Create a reactive variable with ref("Hello, Vue!")',
    'Use {{ }} syntax to display the variable in the template',
  ],
  topics: ['Components', 'Reactivity', 'Template Syntax'],
}
...
&lt;/script&gt;</code></pre>
          ...
          <div class="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            ...
            <ul class="text-sm text-blue-700 dark:text-blue-400 space-y-1">
              <li>• We use <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">&lt;script setup&gt;</code> for Composition API</li>
              <li>• <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">ref()</code> creates reactive state</li>
              <li>• The <code class="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">{{ }}</code> syntax displays the value in the template</li>
            </ul>
          </div>
        </div>
      </div>
